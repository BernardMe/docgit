 ...
 * <p> Description:HttpClient发送GET、POST请求工具类 </p>
 * @Author: wangzhuo
 * @version
 * @date 20190813
 */
...
public class HttpClientUtil {
     ...
     * @throws Exception
     */
    public static Object sendPost(String url, String json, List<NameValuePair> nameValuePairList) throws Exception {
        JSONObject jsonObject = null;
        CloseableHttpClient client = null;
        CloseableHttpResponse response = null;
        try {
